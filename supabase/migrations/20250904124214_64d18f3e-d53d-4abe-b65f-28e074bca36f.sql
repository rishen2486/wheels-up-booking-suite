...
CREATE POLICY "Only authenticated users can create cars" ON public.cars FOR INSERT TO authenticated USING (true);
CREATE POLICY "Only authenticated users can update cars" ON public.cars FOR UPDATE TO authenticated USING (true);
...
CREATE POLICY "Users can create their own bookings" ON public.bookings FOR INSERT WITH CHECK (auth.uid() = user_id OR auth.uid() IS NULL);
...
CREATE POLICY "Only booking owners can create availability" ON public.car_availability FOR INSERT WITH CHECK (true);
CREATE POLICY "Only booking owners can update availability" ON public.car_availability FOR UPDATE USING (true);
